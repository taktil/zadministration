...
class Administration_IncentiveController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->view->page_select="incentive";
    }
    ...
    public function delphotoAction()
    {
    	...
    	$this->_redirect('administration/incentive/index/ong/photos');
    	...
    	if($page){
	    	...
	    	if ($request->isPost()) {
	    		if($request->getParam('titre')){
		    		...
		    		$this->_redirect('administration/incentive');
	    		}
