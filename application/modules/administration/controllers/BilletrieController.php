...
class Administration_BilletrieController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->view->page_select="billetrie";
    }
    ...
    public function delphotoAction()
    {
    	...
    	$this->_redirect('administration/billetrie/index/ong/photos');
    	...
    	if($page){
	    	...
	    	if ($request->isPost()) {
	    		if($request->getParam('titre')){
		    		...
		    		$this->_redirect('administration/billetrie');
	    		}
