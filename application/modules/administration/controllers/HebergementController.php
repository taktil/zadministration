...
class Administration_HebergementController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->view->page_select="hebergement";
    }
    ...
    public function delphotoAction()
    {
    	...
    	$this->_redirect('administration/hebergement/index/ong/photos');
    	...
    	if($page){
	    	...
	    	if ($request->isPost()) {
	    		if($request->getParam('titre')){
		    		...
		    		$this->_redirect('administration/hebergement');
	    		}
